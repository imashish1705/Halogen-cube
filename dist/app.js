...
(function(exports) {
  ...
  var DecAngVelocity = (function () {
      function DecAngVelocity(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      DecAngVelocity.create = function (value0) {
          return function (value1) {
              return new DecAngVelocity(value0, value1);
          };
      };
      return DecAngVelocity;
  })();
  var InncAngVelocity = (function () {
      function InncAngVelocity(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      InncAngVelocity.create = function (value0) {
          return function (value1) {
              return new InncAngVelocity(value0, value1);
          };
      };
      return InncAngVelocity;
  })();
  var RevAngVelocity = (function () {
      function RevAngVelocity(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      RevAngVelocity.create = function (value0) {
          return function (value1) {
              return new RevAngVelocity(value0, value1);
          };
      };
      return RevAngVelocity;
  })();
  ...
  var rotate = function (v) {
      ...
      return function ($193) {
          return rotateZ(v.za)(rotateY(v.ya)(rotateX(v.xa)($193)));
      };
  };
  ...
  var renderView = function (state) {
      ...
      return Halogen_HTML_Elements.div([  ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ renderButton("rotX++")(IncAngVelocity.create(X.value)), renderButton("rotY++")(IncAngVelocity.create(Y.value)), renderButton("rotZ++")(IncAngVelocity.create(Z.value)), renderButton("reverse")(RevAngVelocity.create(Y.value)), renderButton("val++")(InncAngVelocity.create(X.value)), renderButton("val--")(DecAngVelocity.create(X.value)), renderButton("add")(IncAngVelocity.create(Z.value)), renderButton("remove")(IncAngVelocity.create(Z.value)) ])([ Svg_Elements.svg([ Svg_Attributes.viewBox(0.0)(0.0)(viewBoxSize)(viewBoxSize) ])([ Svg_Elements.g([  ])(drawCube(state.shape.edges)(vert2Ds)) ]) ]));
  };
  var oneDegInRadV = 1.745329255e-2; 
  var oneDegInRadD = 1.745329255e-2;
  ...
  var accelerateByV = oneDegInRadV * 60.0;
  var accelerateByD = oneDegInRadD * 30.0;
          ...
          if (v instanceof Tick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  var newCube = (function () {
                      ...
                      $83.angVel = dampenAngVelocity(v1.angVel);
                      $83.shape = newShape;
                      return $83;
                  })();
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (c) {
                      if (v.value0 instanceof X) {
                          ...
                          $95.angVel = (function () {
                              ...
                              $92.xa = v1.angVel.xa + accelerateBy;
                              return $92;
                          })();
                          return $95;
                      };
                      if (v.value0 instanceof Y) {
                          var $101 = {};
                          for (var $102 in c) {
                              if ({}.hasOwnProperty.call(c, $102)) {
                                  $101[$102] = c[$102];
                              };
                          };
                          $101.angVel = (function () {
                              var $98 = {};
                              for (var $99 in c.angVel) {
                                  if ({}.hasOwnProperty.call(c.angVel, $99)) {
                                      $98[$99] = c["angVel"][$99];
                                  };
                              };
                              $98.ya = v1.angVel.ya + accelerateBy;
                              return $98;
                          })();
                          return $101;
                      };
                      if (v.value0 instanceof Z) {
                          var $107 = {};
                          for (var $108 in c) {
                              if ({}.hasOwnProperty.call(c, $108)) {
                                  $107[$108] = c[$108];
                              };
                          };
                          $107.angVel = (function () {
                              var $104 = {};
                              for (var $105 in c.angVel) {
                                  if ({}.hasOwnProperty.call(c.angVel, $105)) {
                                      $104[$105] = c["angVel"][$105];
                                  };
                              };
                              $104.za = v1.angVel.za + accelerateBy;
                              return $104;
                          })();
                          return $107;
                      };
                      throw new Error("Failed pattern match at Cube line 192, column 13 - line 195, column 59: " + [ v.value0.constructor.name ]);
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          };
          if (v instanceof DecAngVelocity) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (c) {
                      if (v.value0 instanceof X) {
                          var $121 = {};
                          for (var $122 in c) {
                              if ({}.hasOwnProperty.call(c, $122)) {
                                  $121[$122] = c[$122];
                              };
                          };
                          $121.angVel = (function () {
                              var $118 = {};
                              for (var $119 in c.angVel) {
                                  if ({}.hasOwnProperty.call(c.angVel, $119)) {
                                      $118[$119] = c["angVel"][$119];
                                  };
                              };
                              $118.xa = v1.angVel.xa - accelerateByD;
                              return $118;
                          })();
                          return $121;
                      };
                      if (v.value0 instanceof Y) {
                          var $127 = {};
                          for (var $128 in c) {
                              if ({}.hasOwnProperty.call(c, $128)) {
                                  $127[$128] = c[$128];
                              };
                          };
                          $127.angVel = (function () {
                              var $124 = {};
                              for (var $125 in c.angVel) {
                                  if ({}.hasOwnProperty.call(c.angVel, $125)) {
                                      $124[$125] = c["angVel"][$125];
                                  };
                              };
                              $124.ya = v1.angVel.ya - accelerateByD;
                              return $124;
                          })();
                          return $127;
                      };
                      if (v.value0 instanceof Z) {
                          var $133 = {};
                          for (var $134 in c) {
                              if ({}.hasOwnProperty.call(c, $134)) {
                                  $133[$134] = c[$134];
                              };
                          };
                          $133.angVel = (function () {
                              var $130 = {};
                              for (var $131 in c.angVel) {
                                  if ({}.hasOwnProperty.call(c.angVel, $131)) {
                                      $130[$131] = c["angVel"][$131];
                                  };
                              };
                              $130.za = v1.angVel.za - accelerateByD;
                              return $130;
                          })();
                          return $133;
                      };
                      throw new Error("Failed pattern match at Cube line 203, column 13 - line 206, column 60: " + [ v.value0.constructor.name ]);
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          };
          if (v instanceof InncAngVelocity) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (c) {
                      if (v.value0 instanceof X) {
                          var $147 = {};
                          ...
                          $147.angVel = (function () {
                              ...
                              $144.xa = v1.angVel.xa + accelerateByV;
                              return $144;
                          })();
                          return $147;
                      };
                      if (v.value0 instanceof Y) {
                          ...
                          $153.angVel = (function () {
                              ...
                              $150.ya = v1.angVel.ya + accelerateByV;
                              return $150;
                          })();
                          return $153;
                      };
                      if (v.value0 instanceof Z) {
                          var $159 = {};
                          for (var $160 in c) {
                              if ({}.hasOwnProperty.call(c, $160)) {
                                  $159[$160] = c[$160];
                              };
                          };
                          $159.angVel = (function () {
                              var $156 = {};
                              for (var $157 in c.angVel) {
                                  if ({}.hasOwnProperty.call(c.angVel, $157)) {
                                      $156[$157] = c["angVel"][$157];
                                  };
                              };
                              $156.za = v1.angVel.za + accelerateByV;
                              return $156;
                          })();
                          return $159;
                      };
                      throw new Error("Failed pattern match at Cube line 214, column 13 - line 217, column 60: " + [ v.value0.constructor.name ]);
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          };
          if (v instanceof RevAngVelocity) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (c) {
                      if (v.value0 instanceof X) {
                          var $173 = {};
                          for (var $174 in c) {
                              if ({}.hasOwnProperty.call(c, $174)) {
                                  $173[$174] = c[$174];
                              };
                          };
                          $173.angVel = (function () {
                              var $170 = {};
                              for (var $171 in c.angVel) {
                                  if ({}.hasOwnProperty.call(c.angVel, $171)) {
                                      $170[$171] = c["angVel"][$171];
                                  };
                              };
                              $170.xa = v1.angVel.xa - accelerateByV;
                              return $170;
                          })();
                          return $173;
                      };
                      if (v.value0 instanceof Y) {
                          var $179 = {};
                          for (var $180 in c) {
                              if ({}.hasOwnProperty.call(c, $180)) {
                                  $179[$180] = c[$180];
                              };
                          };
                          $179.angVel = (function () {
                              var $176 = {};
                              for (var $177 in c.angVel) {
                                  if ({}.hasOwnProperty.call(c.angVel, $177)) {
                                      $176[$177] = c["angVel"][$177];
                                  };
                              };
                              $176.ya = v1.angVel.ya - accelerateByV;
                              return $176;
                          })();
                          return $179;
                      };
                      if (v.value0 instanceof Z) {
                          var $185 = {};
                          for (var $186 in c) {
                              if ({}.hasOwnProperty.call(c, $186)) {
                                  $185[$186] = c[$186];
                              };
                          };
                          $185.angVel = (function () {
                              var $182 = {};
                              for (var $183 in c.angVel) {
                                  if ({}.hasOwnProperty.call(c.angVel, $183)) {
                                      $182[$183] = c["angVel"][$183];
                                  };
                              };
                              $182.za = v1.angVel.za - accelerateByV;
                              return $182;
                          })();
                          return $185;
                      };
                      throw new Error("Failed pattern match at Cube line 225, column 13 - line 228, column 60: " + [ v.value0.constructor.name ]);
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          };
          throw new Error("Failed pattern match at Cube line 170, column 12 - line 230, column 18: " + [ v.constructor.name ]);
      };
  ...
  exports["oneDegInRadD"] = oneDegInRadD;
  exports["oneDegInRadV"] = oneDegInRadV;
  exports["tenDegInRad"] = tenDegInRad;
  exports["accelerateBy"] = accelerateBy;
  exports["accelerateByV"] = accelerateByV;
  exports["accelerateByD"] = accelerateByD;
  exports["dampenPercent"] = dampenPercent;
  exports["initCube"] = initCube;
  exports["Tick"] = Tick;
  exports["IncAngVelocity"] = IncAngVelocity;
  exports["DecAngVelocity"] = DecAngVelocity;
  exports["InncAngVelocity"] = InncAngVelocity;
  exports["RevAngVelocity"] = RevAngVelocity;
  exports["cubes"] = cubes;
